...
public class GetNearbyPlaces extends AsyncTask<Object, String, String> {
    ...
    protected void onPostExecute(String s) {
        try {
            ...
            String imageUrl = "https://maps.googleapis.com/maps/api/place/photo?key=AIzaSyBRuOXoGPaXkGfYFuanupfJ_mrZ7IQ3zog&photoreference=" + photo.getString("photo_reference") + "&maxwidth=" + 600;
